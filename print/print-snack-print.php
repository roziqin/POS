...
<table width="100%" border="0">
  <?php
    ...
    $sql="SELECT * from transaksi_detail jd, barang b, kategori where barang_kategori=kategori_id and barang_id=transaksi_detail_barang_id and transaksi_detail_nota='$t' and kategori_jenis='Snack' ";
    $query=mysql_query($sql);
    while ($data=mysql_fetch_array($query)) {
